const intro = [
  ...
  'Meridian provides bespoke advisory services to help clients identify suitable private banking opportunities, establish relationships with reputable financial institutions, and explore solutions for moving substantial capital internationally.',
  ...
  'Every engagement is handled with the highest standards of confidentiality, professionalism, and compliance. At Meridian, we serve as a trusted advisory partner, connecting clients with global financial opportunities and helping them navigate complex financial decisions with confidence and discretion.',
];
...
const process = [
  ...
  ['03', 'Secure Execution & Ongoing Support', 'Once the strategy is approved, Meridian coordinates the next steps through trusted professional networks and vetted financial partners. We provide ongoing support throughout the process, ensuring each engagement is handled with discretion, transparency, and attention to detail.', ['Coordinate introductions and implementation steps', 'Monitor progress throughout the engagement', 'Provide confirmation and ongoing support with complete discretion']],
];
  ...
  return (
    <div className="content-page">
      <section className="blue-panel">
        ...
        <h1>The Meridian Difference</h1>
        <p>
          Meridian is a premier global financial advisory firm dedicated to helping
