...
export default function RegisterCapabilityDashboard() {
  ...
  const inputCls = 'w-full h-12 md:h-11 px-4 text-[14px] font-medium leading-[1.4] tracking-[-0.02em] bg-[#F5F6FA] border border-gray-200 rounded-xl md:rounded-lg outline-none placeholder:text-gray-400 focus:border-white/80 transition-colors';
  ...
  return (
    <DashboardLayout title="Register Capability">
      <div className="bg-[#0F61E9] rounded-2xl p-3 pt-9 md:p-10 max-w-4xl mx-auto">
        <h2 className="text-[30px] md:text-[40px] font-semibold text-white mb-3 md:mb-2 leading-[1.05] md:leading-[1.15] tracking-[-0.04em] text-left md:text-center capitalize" style={{ fontFamily: "'Instrument Sans', sans-serif" }}>Register A Capability</h2>
        <p className="text-white md:text-blue-200 text-[14px] font-medium leading-[1.45] md:leading-[1.4] tracking-[-0.02em] text-left md:text-center mb-7 md:mb-8 max-w-[360px] md:max-w-none" style={{ fontFamily: "'Instrument Sans', sans-serif" }}>Tell us what you're able to facilitate. Reviewed internally before it's ever considered for matching.</p>
